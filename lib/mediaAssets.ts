...
export interface GalleryItem {
  src: string;
  alt: string;
  category: 'shingles' | 'tile' | 'flat' | 'metal' | 'wood' | 'repairs' | 'gutters';
  thumb?: string;
}
...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  { src: img(CS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.53_8ee98947-1.jpg'), alt: 'Bay Area roof install', category: 'shingles' },
  { src: img(CS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.53_8f7d24cf-1 (1).jpg'), alt: 'Residential roofing project', category: 'shingles' },
  { src: img(CS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.53_8f7d24cf-1 (2).jpg'), alt: 'Residential roofing project 2', category: 'shingles' },
  { src: img(CS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.53_8f7d24cf-1.jpg'), alt: 'Roof installation Bay Area', category: 'shingles' },
  { src: img(CS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.54_b6494ea9.jpg'), alt: 'Premium residential roof', category: 'shingles' },
  { src: img(CS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.55_8edd29c1 (1).jpg'), alt: 'Roofing project', category: 'shingles' },
  ...
  { src: img(CT, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.33_1386d0e9.jpg'), alt: 'Roof project completed', category: 'tile' },
  { src: img(CT, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.35_1e0245a7.jpg'), alt: 'Residential concrete tile roofing', category: 'tile' },
  ...
  { src: img(CT, 'WhatsApp Image 2026-07-07 at 9.59.21 PM (3).jpeg'), alt: 'New tile roof installation', category: 'tile' },
  { src: img(CT, 'WhatsApp Image 2026-07-07 at 9.59.23 PM (3).jpeg'), alt: 'Bay Area concrete tile project', category: 'tile' },

  // ── Wood Shingles ──
  { src: img(WS, 'CEDAR-SHINGLES-ROOF.-585292078 - Copy.jpeg'), alt: 'Cedar shingle roof', category: 'wood' },
  { src: img(WS, 'What-is-a-Cedar-Shake-Roof- - Copy.jpg'), alt: 'Cedar shake roof', category: 'wood' },
  { src: img(WS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.29_fa840603-2.jpg'), alt: 'Wood shingle roofing project', category: 'wood' },
  { src: img(WS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.30_091a5253-1.jpg'), alt: 'Wood shingle roof installation', category: 'wood' },
  { src: img(WS, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.30_be35797d.jpg'), alt: 'Bay Area wood shingle project', category: 'wood' },
  { src: img(WS, 'WhatsApp Image 2026-07-07 at 9.59.16 PM.jpeg'), alt: 'Recent wood shingle project 2026', category: 'wood' },

  // ── Flat Roof PVC and TPO ──
  { src: img(FP, 'roof4.jpeg'), alt: 'Flat roof installation', category: 'flat' },
  ...
  { src: img(FP, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.53_2677088a-1.jpg'), alt: 'Flat roofing project complete', category: 'flat' },
  { src: img(FP, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.54_0c96fcc3-1.jpg'), alt: 'Commercial flat roof', category: 'flat' },
  { src: img(FP, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.54_157b8369.jpg'), alt: 'Flat roofing work Bay Area', category: 'flat' },
  ...
  // ── Standing Seam Metal Roofs ──
  { src: img(SM, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.43_0a034a7c.jpg'), alt: 'Metal roof installation', category: 'metal' },
  { src: img(SM, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.43_9b5073ea.jpg'), alt: 'Standing seam metal roof', category: 'metal' },
  { src: img(SM, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.43_bb5e607b.jpg'), alt: 'Metal roofing project', category: 'metal' },
  { src: img(CS, 'WhatsApp Image 2026-07-07 at 9.59.17 PM (1).jpeg'), alt: 'Bay Area metal roofing 2026', category: 'metal' },
  { src: img(CS, 'WhatsApp Image 2026-07-07 at 9.59.21 PM.jpeg'), alt: 'Metal roofing project 2026', category: 'metal' },
  { src: img(CS, 'WhatsApp Image 2026-07-07 at 9.59.21 PM (1).jpeg'), alt: 'Bay Area roofing crew', category: 'metal' },
  { src: img(CS, 'WhatsApp Image 2026-07-07 at 9.59.21 PM (2).jpeg'), alt: 'Metal roof replacement project', category: 'metal' },
  { src: img(CS, 'WhatsApp Image 2026-07-07 at 9.59.21 PM (4).jpeg'), alt: 'Metal roofing work in progress', category: 'metal' },
  { src: img(CS, 'WhatsApp Image 2026-07-07 at 9.59.22 PM (2).jpeg'), alt: 'Metal roofing installation', category: 'metal' },
  ...
  // ── Roof Repairs ──
  { src: img(RR, 'IN-Roof-Repair-and-Roof-Replacement - Copy - Copy.jpg'), alt: 'Roof repair and replacement', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.27_897877f0.jpg'), alt: 'Roof repair project', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.30_62bcc177.jpg'), alt: 'Roof repair work', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.30_8c2fdd4c.jpg'), alt: 'Roof repair Bay Area', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.32_41cd3e5b.jpg'), alt: 'Roofing crew at work', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.36_7b922921.jpg'), alt: 'Bay Area roofing repair project', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.36_e50a0081.jpg'), alt: 'Roof repair installation', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.39_31fde525.jpg'), alt: 'Roofing repair in progress', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.39_3e7cacbb.jpg'), alt: 'Roof repair project', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.39_7cdf9241.jpg'), alt: 'Roof restoration', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.42_ce5b3a92.jpg'), alt: 'Commercial roof repair', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.42_e21dfc8e.jpg'), alt: 'Commercial roofing repair Bay Area', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.45_46258076.jpg'), alt: 'Roof repair completed', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.47_a911a20c.jpg'), alt: 'Roofing crew Bay Area', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.48_02cfda82-1.jpg'), alt: 'Roof repair project', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.48_489cbd2e.jpg'), alt: 'Roofing repair detail', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.48_c63aa36e.jpg'), alt: 'Premium roofing repair', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.55_6b838d67-1.jpg'), alt: 'Roof repair Bay Area', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.56_6c3ae428 - Copy.jpg'), alt: 'Roofing repair project', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.56_6c3ae428.jpg'), alt: 'Bay Area roof repair', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.56_b0387241.jpg'), alt: 'Roof repair work', category: 'repairs' },
  { src: img(RR, 'Imagen-de-WhatsApp-2025-06-15-a-las-16.57.56_c2a3806b-1.jpg'), alt: 'Premium roof repair project', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.18 PM (3).jpeg'), alt: 'Roof repair project', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.18 PM (4).jpeg'), alt: 'Premium roofing repair work', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.19 PM (1).jpeg'), alt: 'Commercial roofing repair', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.19 PM (3).jpeg'), alt: 'Roofing repair detail', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.20 PM (1).jpeg'), alt: 'Roof repair Bay Area', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.20 PM (3).jpeg'), alt: 'Roof repair 2026', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.20 PM (4).jpeg'), alt: 'Premium roof repair', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.22 PM (1).jpeg'), alt: 'Commercial roof repair project', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.22 PM (4).jpeg'), alt: 'Roof repair Bay Area', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.22 PM (5).jpeg'), alt: 'Premium roofing repair', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.22 PM.jpeg'), alt: 'Roofing crew at work', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.23 PM (2).jpeg'), alt: 'Roof repair', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.23 PM (4).jpeg'), alt: 'Roof repair project complete', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.23 PM (5).jpeg'), alt: 'Premium roof repair work', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.23 PM.jpeg'), alt: 'Roofing repair installation', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.24 PM (1).jpeg'), alt: 'Bay Area roofing repair project', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.24 PM (3).jpeg'), alt: 'Roof repair replacement', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.24 PM (5).jpeg'), alt: 'New roof repair installation', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.24 PM (6).jpeg'), alt: 'Roofing crew Bay Area', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.24 PM.jpeg'), alt: 'Roofing repair project', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.25 PM (1).jpeg'), alt: 'Roof repair maintenance project', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.25 PM (2).jpeg'), alt: 'Roof repair Bay Area', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.25 PM.jpeg'), alt: 'Premium roofing repair project', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.26 PM (1).jpeg'), alt: 'Commercial roof repair install', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.26 PM (2).jpeg'), alt: 'Bay Area commercial roof repair', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.26 PM (3).jpeg'), alt: 'Roofing repair project 2026', category: 'repairs' },
  { src: img(RR, 'WhatsApp Image 2026-07-07 at 9.59.26 PM (4).jpeg'), alt: 'Premium roof repair installation', category: 'repairs' },
];
